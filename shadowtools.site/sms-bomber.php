...
<body>
  ...
  <div class="log">
    Developed by <strong>Shadow Innovations</strong>
  </div>

  <a class="channel-btn" href="https://whatsapp.com/channel/0029ValH0yv6GcG8pM6AN432" target="_blank">Join Our WhatsApp Channel</a>
  <a class="channel-btn" href="https://t.me/shadowinnovations" target="_blank">Join Our Telegram Channel</a>

  <div class="footer">
    © 2025 All Rights Reserved — <strong>Shadow Innovations</strong>
  </div>
    ...
    function startBombing(event) {
      ...
      form.submit();
        ...
        Swal.fire({
                ...
                html: '<div style="color: #00fff7; text-shadow: 0 0 10px #00ffee;">Successfully sent <b>100 OTPs</b> to <b>03319198321</b>! 🚀<br><i>Powered by Shadow Innovations</i></div>',
                icon: 'success',
